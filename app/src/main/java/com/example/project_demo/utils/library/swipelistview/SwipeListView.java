...
public class SwipeListView extends ListView {
     ...
     */
    public SwipeListViewTouchListener touchListener;
    ...
    private void init(AttributeSet attrs) {
        ...
        boolean swipeMultipleSwipeMode = true;
        ...
        if (attrs != null) {
            ...
            swipeMultipleSwipeMode = styled.getBoolean(R.styleable.SwipeListView_swipeMultipleSwipeMode, true);
        }
        ...
        touchListener.setSwipeMultipleSwipeMode(swipeMultipleSwipeMode);
