 ...
 * to {@link DragSortListViewWithSwipe#setAdapter(ListAdapter)} and, since
 * this class implements the {@link DragSortListViewWithSwipe.DragSortListener}
 * interface, it is automatically set as the DragSortListener for
 * the DragSortListView instance.
 */
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortListViewWithSwipe.DragSortListener {
     ...
     *
     * @see DragSortListViewWithSwipe.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see DragSortListViewWithSwipe.RemoveListener#remove(int)
     */
    @Override
