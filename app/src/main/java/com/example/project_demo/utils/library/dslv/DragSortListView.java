    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (useDefault) {
                ...
                mFloatViewManager = (FloatViewManager) controller;
    ...
    private class AdapterWrapper extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                if (textColor != 0) {
                    View textView = child.findViewById(R.id.text);
                    if (textView instanceof TextView) {
                        ((TextView) textView).setTextColor(ContextCompat.getColor(child.getContext(), textColor));
                    }
                }
