...
package com.example.project_demo.utils.library.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private boolean swipeMultipleSwipeMode;
    ...
    /**
     * Set multiple swipe row
     *
     * @param swipeMultipleSwipeMode
     */
    public void setSwipeMultipleSwipeMode(boolean swipeMultipleSwipeMode) {
        this.swipeMultipleSwipeMode = swipeMultipleSwipeMode;
    }
    ...
    protected boolean isSwipeEnabled() {
        return swipeMode != SwipeListView.SWIPE_MODE_NONE && !paused;
    }
    ...
    protected void closeAnimate(int position) {
        ...
        if(v != null)
        closeAnimate(v.findViewById(swipeFrontView), position);
    }
    ...
    /**
     * Close all opened items except last opened item
     */
    void closeOpenedItemsExceptLastOpened() {
        if (opened != null) {
            int start = swipeListView.getFirstVisiblePosition();
            int end = swipeListView.getLastVisiblePosition();
            for (int i = start; i <= end; i++) {
...
//                }
                ...
                if(!swipeMultipleSwipeMode){
                    closeOpenedItemsExceptLastOpened();
                }
                break;
            }
