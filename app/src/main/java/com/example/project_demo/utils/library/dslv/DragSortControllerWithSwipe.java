 ...
 */
public class DragSortControllerWithSwipe extends SimpleFloatViewManager implements
	...
	private DragSortListViewWithSwipe mDslv;
	 ...
	 *            The DSLV instance
	 */
	public DragSortControllerWithSwipe(DragSortListViewWithSwipe dslv) {
		this(dslv, 0, ON_DOWN, FLING_REMOVE);
	}

	public DragSortControllerWithSwipe(DragSortListViewWithSwipe dslv, int dragHandleId,
	...
	public boolean startDrag(int position, int deltaX, int deltaY) {
		...
		if (mSortEnabled && !mIsRemoving) {
			dragFlags |= DragSortListViewWithSwipe.DRAG_POS_Y
					| DragSortListViewWithSwipe.DRAG_NEG_Y;
		}
		if (mRemoveEnabled && mIsRemoving) {
			dragFlags |= DragSortListViewWithSwipe.DRAG_POS_X;
			dragFlags |= DragSortListViewWithSwipe.DRAG_NEG_X;
		}
	...
	public boolean onTouch(View v, MotionEvent ev) {
		if(mDslv.isDragMode()){
			...
			//return false;
			return mDslv.touchListener.onTouch(v, ev);
